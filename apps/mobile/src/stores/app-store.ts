...
export const useAppStore = create<AppState>()(persist(
  (set) => ({ draftAmount: 50, draftMix: "bigfour", setPlan: (plan) => set({ plan }), setCardId: (cardId) => set({ cardId }), clearUserState: () => set({ plan: undefined, cardId: undefined }), setDraft: (draft) => set(draft) }),
  {
    name: "pile-draft-v1",
