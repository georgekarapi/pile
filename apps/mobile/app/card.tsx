...
export default function CardScreen() {
  ...
  const isPreIpoOnly = Boolean(
    ...
    (!weights?.length && draftBundle === "prestocks")
  );
      ...
      <View className="pt-[50px]">
        ...
        <View className="mt-4 rounded-[20px] bg-pile-fog p-[20px]">
          ...
          <Body className="mt-2 text-[13px] text-pile-muted">
            Card spending requires collateral-eligible stocks (like The Big Four or FAANG). Add them to your weekly bundle to unlock card spending.
          </Body>
        </View>
        ...
        <View className="mt-6 gap-3">
          <Button onPress={() => router.push("/weekly-plan")}>Change weekly bundle</Button>
