...
export default function HealthScreen() {
  ...
  const explanation = state === "unavailable" ? "Refresh to see your current borrowing before making a repayment." : state === "no_debt" ? "Your card room can change as your pile changes." : state === "no_funds" ? "To repay, add USDC to your Pileup wallet first." : "Paying back reduces your debt after the transaction confirms.";
